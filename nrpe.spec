...
Source0  : https://github.com/NagiosEnterprises/nrpe/releases/download/nrpe-4.0.3/nrpe-4.0.3.tar.gz
...
%prep
%setup -q -n nrpe-4.0.3
cd %{_builddir}/nrpe-4.0.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605724745
...
cp %{_builddir}/nrpe-4.0.3/LICENSE.md %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
cp %{_builddir}/nrpe-4.0.3/macros/LICENSE %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
cp %{_builddir}/nrpe-4.0.3/macros/LICENSE.md %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
