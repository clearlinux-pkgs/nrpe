...
%prep
%setup -q -n nrpe-4.1.0
cd %{_builddir}/nrpe-4.1.0
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658768806
...
cp %{_builddir}/nrpe-%{version}/LICENSE.md %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
cp %{_builddir}/nrpe-%{version}/macros/LICENSE %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
cp %{_builddir}/nrpe-%{version}/macros/LICENSE.md %{buildroot}/usr/share/package-licenses/nrpe/c2a44cc3dc367ff71d4edd9aeeb8a2651204ea91
